...
import {
  ...
  type PaymentMethod,
} from "@/features/booking/components/payment/PaymentMethodSelector";
import { PaymentSummaryCard } from "@/features/booking/components/payment/PaymentSummaryCard";
import { BankTransferPanel } from "@/features/booking/components/payment/BankTransferPanel";
import { CounterPaymentPanel } from "@/features/booking/components/payment/CounterPaymentPanel";
import {
  mockCourts,
  mockCustomerCourtTypes as mockCourtTypes,
  mockServiceItems,
  mockCoaches,
} from "@/features/booking/mockData";
...
export default function PaymentPage() {
  ...
  const [bookingData, setBookingData] = React.useState<{
    ...
    courtType: typeof mockCourtTypes[0];
